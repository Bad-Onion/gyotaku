...
GYOTAKU é um jogo relaxante de pescaria e pintura desenvolvido para a Felpojam.

Aqui, você tem liberdade criativa para personalizar suas capturas: após pescar, você pode carimbar os peixes da forma que quiser e registrá-los no seu catálogo pessoal de Gyotaku (uma arte tradicional japonesa de impressão de peixes).
